...
assert_gitignore(){
  ...
  # Assert that customised core files were added to the git repository.
  ...
  assert_git_file_is_not_tracked "docroot/sites/all/themes/custom/star_wars/build/css/star_wars.min.css"
  assert_git_file_is_not_tracked "docroot/sites/all/themes/custom/star_wars/build/js/star_wars.js"
...
assert_ahoy_lint(){
  ...
  echo ".abc{margin: 0px;}" >> docroot/sites/all/themes/custom/star_wars/scss/components/_layout.scss
  sync_to_container
...
assert_ahoy_test_unit(){
  ...
  sed -i -e "s/assertEquals/assertNotEquals/g" docroot/sites/all/modules/custom/star_wars_core/tests/unit/StarWarsCoreExampleTest.php
  sync_to_container
